...
public class MyController
{
	...
	public String addProduc(HttpServletRequest request) throws ServerException,IOException
	{
		...
		System.out.println(product_id+" "+product_price+" "+product_discount+" "+Discount_valid+""+product_type);
		
		Discounts d = new Discounts(product_id, product_price, product_discount, Discount_valid,product_type);
	...
	public String show() throws ClassNotFoundException,SQLException
	{
		...
		{
			System.out.println(ds.getProduct_id()+" "+ds.getProduct_price()+" "+ds.getProduct_discount()+" "+ds.getDiscount_valid()+""+ds.getProduct_type());
			return "products";
		}
		else
		{
